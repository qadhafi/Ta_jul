            ...
            <div class="card-body">
                ...
                <?= isset($input->id_inventaris) ? form_hidden('id_inventaris', $input->id_inventaris) : '' ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_bagus" class="form-control" value="<?= $input->jumlah_bagus ?>" placeholder="Masukan Barang Bagus">
                    </div>
                    <div class="form-group">
                        <label>Jumlah Rusak</label>
                        <input type="number" name="jumlah_rusak" class="form-control" value="<?= $input->jumlah_rusak ?>" placeholder="Masukan Barang Rusak">
                    </div>
                    <!-- <div class="form-group">
