...
class MY_Model extends CI_Model
{
    ...
    public function getOrtu($user_id)
    {
        return $this->db->where('id_user', $user_id)->get('orangtua')->row();
    }
    ...
    public function join($table, $type = 'left', $primary_key = null)
    {
        if($primary_key == null) {
            $this->db->join($table, "$this->table.id_$table = $table.id_$table", $type);
        } else {
            $this->db->join($table, "$this->table.$primary_key = $table.id_$table", $type);
        }
        return $this;
    }
